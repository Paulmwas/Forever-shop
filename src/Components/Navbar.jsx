...
const Navbar = () => {
  ...
  return (
    <div className="flex  items-center justify-between py-5 font-medium top-0 z-[99] sticky bg-white">
        ...
        <div className='flex items-center gap-6'>
            ...
            <div className='flex flex-col text-gray-600'>
                <div onClick={()=>setVisible(false)} className='flex flex-row items-center gap-4 p-3 cursor-pointer'>
